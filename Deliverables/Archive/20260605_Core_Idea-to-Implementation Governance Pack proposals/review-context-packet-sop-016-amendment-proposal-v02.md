...
|---|---|---|
| GL-018 proposal | `Deliverables/20260605_Core_Idea-to-Implementation Governance Pack proposals/idea-routing-gl-proposal-v02.md` | PENDING — not yet implemented |
| SOP-018 proposal | `Deliverables/20260605_Core_Idea-to-Implementation Governance Pack proposals/idea-routing-sop-proposal-v02.md` | PENDING — not yet implemented |
| SOP-016 RCP amendment proposal | `Deliverables/20260605_Core_Idea-to-Implementation Governance Pack proposals/review-context-packet-sop-016-amendment-proposal-v02.md` | PENDING — not yet implemented |
| Smoke test plan | `Deliverables/20260605_Core_Idea-to-Implementation Governance Pack proposals/idea-routing-smoke-test-plan-v02.md` | PENDING — not yet executed |
...
### Example 4 — Proposal Review with Review Context Packet (v02 DP sequence)

**Scenario:** A proposal for a script extension (S2, Medium impact) has been prepared. The Maintainer has confirmed that all six Route B escalation conditions are false — the idea is therefore Route B. Wait — the proposal modifies an existing script (system file). This triggers Route B escalation condition 1. The route escalates to Route C. An RCP is now required.

**Step-by-step:**

1. Maintainer classifies the idea: S2-Medium, Route B.
2. Maintainer checks Route B escalation conditions. Condition 1 is true (system file modified). Route B escalates to Route C.
...
- Field 8: Review the proposal at Field 2 for scope accuracy, system-file change completeness, and review check compliance.
...
6. Section 11.7 lists all four governance-pack companion documents with their current paths and pending status.
...
8. Worked Example 4 uses v02 DP numbering (DP-3 for Owner decision post-Review Gate; DP-4 for implementation confirmation).
...
| Request amendments | Specific changes required; revised v03 prepared; SOP-016 not modified until approved |
| Approve with modifications | Owner states exact modifications; v03 created before SOP-016 is modified |

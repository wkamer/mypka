...
## 10. Pack-level Implementation Order

> **Note:** This section applies only to the initial implementation of this governance pack. After the pack is fully implemented and post-checked, this note is no longer relevant and may be omitted from the final GL-018 file.
...
9. Section 10 (Pack-level Implementation Order) correctly states the four-step implementation sequence.
...
| Request amendments | Specific changes required; revised v03 proposal prepared; GL-018 not created until approved |
| Approve with modifications | Owner states exact modifications; v03 created before GL-018 is written |

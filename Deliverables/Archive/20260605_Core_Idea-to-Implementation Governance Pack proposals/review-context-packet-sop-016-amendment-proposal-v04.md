...
|---|---|---|
| GL-018 proposal | `Deliverables/20260605_Core_Idea-to-Implementation Governance Pack proposals/idea-routing-gl-proposal-v04.md` | PENDING — not yet implemented |
| SOP-018 proposal | `Deliverables/20260605_Core_Idea-to-Implementation Governance Pack proposals/idea-routing-sop-proposal-v04.md` | PENDING — not yet implemented |
| SOP-016 RCP amendment proposal | `Deliverables/20260605_Core_Idea-to-Implementation Governance Pack proposals/review-context-packet-sop-016-amendment-proposal-v04.md` | PENDING — not yet implemented |
| Smoke test plan | `Deliverables/20260605_Core_Idea-to-Implementation Governance Pack proposals/idea-routing-smoke-test-plan-v04.md` | PENDING — not yet executed |
...
### Example 4 — Proposal Review with Review Context Packet (v04)
...
6. Section 11.7 lists all four governance-pack companion documents with their current v04 paths and pending status.
...
| Request amendments | Specific changes required; revised v05 prepared; SOP-016 not modified until approved |
| Approve with modifications | Owner states exact modifications; v05 created before SOP-016 is modified |

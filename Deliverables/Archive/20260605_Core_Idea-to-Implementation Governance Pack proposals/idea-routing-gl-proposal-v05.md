...
1. **P8 updated — lifecycle timing made explicit** — P8 now states that the implementation-route lifecycle decision occurs after DP-5 (implementation report acceptance) and that the decision is taken at DP-6. Other accepted deliverables produced during idea routing — such as proposals, research briefs, review reports, or closure reports — may separately receive lifecycle processing under SOP-017 when accepted as standalone deliverables. Lifecycle processing may not be executed without explicit Owner approval.
2. **Section 7 SOP-015 row updated — file category terminology** — The SOP-015 row now correctly distinguishes governance file changes (requiring S8/Route D/SOP-015) from operational system file changes (Route C or higher, subject to Review Gate, DP-3, and DP-4). The phrase "system-file change" has been replaced with the more precise category terms. A cross-reference to SOP-018 Section 2.4 is included.
3. **Acceptance criteria 14 and 15 added** — Criterion 14 verifies P8 lifecycle timing. Criterion 15 verifies that the Relationship to Existing Governance table uses the correct governance file and operational system file terminology.
...
1. **No GL-018 content changes required** — The v04 amendment round targeted SOP-018 EX-5 and the SOP-016 RCP amendment Section 11.2. GL-018 content (P1 through P11 and Sections 1 through 9) is unchanged. P6 already correctly carves out Route B without escalation via the cross-reference to SOP-018 Section 9. No principle, section, or acceptance criterion required correction in this round.
2. **Companion file paths updated to v05** — All companion document references within this proposal wrapper updated from v04 to v05 versions.
...
14. GL-018 P8 lifecycle timing is explicit: the implementation-route lifecycle decision occurs after DP-5 (implementation report acceptance) at DP-6; other accepted deliverables produced during idea routing may separately receive lifecycle processing per SOP-017 when accepted as standalone deliverables; lifecycle processing may not be executed without explicit Owner approval.
15. The SOP-015 row in the Relationship to Existing Governance table (Section 7) correctly distinguishes governance file changes (S8/Route D/SOP-015) from operational system file changes (Route C or higher). The table does not use "system-file change" where "governance file" or "operational system file" is the more precise term.
...
| Request amendments | Specific changes required; revised v06 proposal prepared; GL-018 not created until approved |
| Approve with modifications | Owner states exact modifications; v06 created before GL-018 is written |
...
| 2026-06-05 | v04 | Updated P8 (lifecycle timing explicit); updated SOP-015 row in Section 7 (governance file vs. operational system file distinction; SOP-018 Section 2.4 cross-reference); added acceptance criteria 14 and 15; Owner Decision Options reference v05 |
| 2026-06-05 | v05 | No GL-018 content changes. Companion file references in proposal wrapper updated to v05 versions. Owner Decision Options reference v06. |

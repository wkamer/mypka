...
**Tests:** idea-routing-gl-proposal-v03.md, idea-routing-sop-proposal-v03.md, review-context-packet-sop-016-amendment-proposal-v03.md
...
The following documents are pending approval. For smoke test purposes, use the v03 proposal content as the governance definition under test.

| Document | Path |
|---|---|
| GL-018 proposal v03 | `Deliverables/20260605_Core_Idea-to-Implementation Governance Pack proposals/idea-routing-gl-proposal-v03.md` |
| SOP-018 proposal v03 | `Deliverables/20260605_Core_Idea-to-Implementation Governance Pack proposals/idea-routing-sop-proposal-v03.md` |
| SOP-016 RCP amendment v03 | `Deliverables/20260605_Core_Idea-to-Implementation Governance Pack proposals/review-context-packet-sop-016-amendment-proposal-v03.md` |
| Smoke test plan v03 (this document) | `Deliverables/20260605_Core_Idea-to-Implementation Governance Pack proposals/idea-routing-smoke-test-plan-v03.md` |

### File Category Definitions (from SOP-018 v03 Section 2.4)
...
### Route Definitions (from SOP-018 v03 Section 9)
...
**Route B escalation conditions (from SOP-018 v03 Section 9):**
...
### Owner Decision Points (from SOP-018 v03 Section 12)
...
### Review Gate Modes (from SOP-018 v03 Section 2.3 and SOP-016)
...
### Role-Based Definitions (from SOP-018 v03 Section 2)
...
3. All test cases use v02 DP numbering (DP-1 through DP-6); no test case references a DP that does not exist in the SOP-018 v03 sequence.
...
| Request amendments | Specific changes required; revised v04 prepared |
| Approve with modifications | Owner states modifications; v04 created before smoke test is considered for execution |

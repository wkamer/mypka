...
v01 contained Dutch wording in proposed system-facing and governance-facing content. Specifically: the proposed CLAUDE.md subsection title used "verplicht" (Dutch for mandatory); the proposed trigger line was written entirely in Dutch; the Iris review prompt quoted the Dutch title; the Owner response options used Dutch labels (Ja/Nee/Correctie); the post-check table quoted the Dutch title.

All Dutch wording in system-facing and governance-facing content has been replaced with English in v02. References to the existing CLAUDE.md subsection "Domain Check Before Execution — verplicht" are preserved as-is: that is a citation of an existing live file element, not new proposed text.

No other content changes. Scope, structure, rule logic, and write-plan are unchanged from v01.
...
**Violation trigger:** If Larry creates an execution brief when the associated write-list contains batch-stop rules that are not included in the brief — stop, correct the brief before execution, report the correction to the Owner.
...
- **Correction** — specify what to change; Larry creates v03 and Iris reviews again before re-presenting
...
| Text matches approval | Rule text matches the approved version from this proposal (or v03+ if a correction was applied) exactly |
...
`Deliverables/20260607_Core_SOP-019 LC-6 Execution Briefing Rule/lc-6-sop-019-initiation-proposal-v02.md`

v01 remains in the same folder as a version history record and is not deleted.

---

## 14. Next Step Recommendation

**Recommended next step: Iris review of this proposal (v02).**

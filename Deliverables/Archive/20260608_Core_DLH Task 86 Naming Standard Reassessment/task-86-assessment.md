...
- Naming Standardization Proposal v01 (2026-06-07, folder:
  ...
  superseded by the GL Amendment Proposal v01 produced in this session. Proposal v01 should
  be marked `superseded` in `deliverable_lifecycle` (ID=48... wait, proposal v01 was registered
  separately — see `deliverable_lifecycle` for the correct ID).
...
*Delivered at: Deliverables/20260608_Core_DLH Task 86 Naming Standard Reassessment/task-86-assessment.md*

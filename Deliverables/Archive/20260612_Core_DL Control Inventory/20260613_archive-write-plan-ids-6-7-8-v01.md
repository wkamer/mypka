...
```bash
ls "/opt/myPKA/Deliverables/" | grep -E "20260530|20260531"
```
Expected: no output (all three folders moved out).

**V-2:** Confirm folders are present in Archive:
```bash
ls "/opt/myPKA/Deliverables/Archive/" | grep -E "20260530|20260531"
```
Expected: all three folder names appear.
...
Delivered at: Deliverables/20260612_Core_DL Control Inventory/20260613_archive-write-plan-ids-6-7-8-v01.md

# Memory Domain Routing Protocol — GL-015 Proposal v0.4
...
**Previous version:** proposal-v0.3.md (reviewed 2026-06-04, amendments requested by Owner Walter Kamer)
**Requires approval by:** Owner Walter Kamer — see Approval Gate

---

## Revision Notes — v0.3 to v0.4

Two amendments applied per Owner Walter Kamer's review of v0.3 (2026-06-04):

| # | Amendment | Section(s) changed |
|---|---|---|
| R9 | GL Changelog entry corrected to implementation-ready form | §2.2 GL Changelog |
| R10 | GL Purpose sentence reworded to be implementation-safe (AGENT.md pointers are optional) | §2.2 GL Purpose |

All other v0.3 content preserved unchanged.

---

## Revision Notes — v0.2 to v0.3

| # | Amendment | Section(s) changed |
|---|---|---|
| R7 | gl-index.md row description corrected from Dutch to English | §3.1 |
| R8 | Clarifying sentence added: canonical Path column is authoritative when display names and file paths differ | §2.2 GL §2 |
...
**Proposed section text:** The following `## Memory Domain Routing` block is appended as the last section of each named AGENT.md file. The text is identical across agents except for the database path and domain tag.
...
2. Database path matches the agent's canonical database from the table below
...
| gl-index.md contains GL-015 entry | Read file | English row present with `[[GL-015_Memory Domain Routing Protocol]]` after GL-014 row |
...
Owner identifies gaps, incorrect routing assignments, or missing elements. Larry revises as v0.5 per SOP-015.
...
Approval phrase: "approve GL-015 proposal v0.4"

- Approval of any prior version does not carry over to v0.4
...
*Delivered at: Deliverables/20260604_Core_Architecture Triage Memory Domain Routing/proposal-v0.4.md*
